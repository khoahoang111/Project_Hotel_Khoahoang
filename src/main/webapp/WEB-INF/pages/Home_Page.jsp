    ...
    <body>
        ...
        <div class="block-31" style="position: relative;">
            <div class="owl-carousel loop-block-31 ">
                <div class="block-30 item" style="background-image: url(<c:url value="/resources/images/bg_2.jpg"/>);" data-stellar-background-ratio="0.5">
                    <div class="container">
                ...
                <div class="block-30 item" style="background-image: url(<c:url value="/resources/images/bg_1.jpg"/>);" data-stellar-background-ratio="0.5">
                    <div class="container">
                        <div class="row align-items-center">
                            <div class="col-md-10">
                                <span class="subheading-sm">Welcome</span>
                ...
                <div class="block-30 item" style="background-image: url(<c:url value="/resources/images/bg_3.jpg"/>);" data-stellar-background-ratio="0.5">
                    <div class="container">
                        <div class="row align-items-center">
                            <div class="col-md-10">
                                <span class="subheading-sm">Welcome</span>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3 mb-lg-0 col-lg-3">
                                    ...
                                    <div class="field-icon-wrap">
                                        ...
                                        <input class="form-control" type="date" id="depart" name="check_in" min="${date}" ">      
                                    </div>
                                </div>
                                <div class="col-md-6 mb-3 mb-lg-0 col-lg-3">
                                    ...
                                    <div class="field-icon-wrap">
                                        <!--                                        <div class="icon"><span class="icon-calendar"></span></div>-->
                                        <input class="form-control" type="date" id="return" name="check_out" min="${date}" ">                                                
                                    </div>
                                </div>
                                <div class="col-md-6 mb-3 mb-lg-0 col-lg-3">
                                    ...
                                    <div class="field-icon-wrap">
                                        ...
                                        <select name="roomTypeId" class="form-control">
                                            <c:forEach items="${roomtype}" var="c">
                    ...
                    <div class="col-md-12 ">
                        <div class="nonloop-block-13 owl-carousel">
                            ...
                            <div class="item">
                                <div class="block-34">
                                    <div class="image">
                                        <a href="#"><img src="<c:url value="/resources/images/img_4.jpg"/>" alt="Image placeholder"></a>
                                    </div>
                                    <div class="text">
                            ...
                            <div class="item">
                                <div class="block-34">
                                    <div class="image">
                                        <a href="#"><img src="<c:url value="/resources/images/img_5.jpg"/>" alt="Image placeholder"></a>
                                    </div>
                                    <div class="text">
                            ...
                            <div class="item">
                                <div class="block-34">
                                    <div class="image">
                                        <a href="#"><img src="<c:url value="/resources/images/img_6.jpg"/>" alt="Image placeholder"></a>
                                    </div>
                                    <div class="text">
                                        <h2 class="heading">VIP Room</h2>
                                ...
                                <div class="col-md-12 block-13">
                                    <div class="nonloop-block-13 owl-carousel">
                                        <div class="item">
                                            <div class="block-34">
                                                <div class="image">
                                                    <a href="#"><img src="<c:url value="/resources/images/menu_1.jpg"/>" alt="Image placeholder"></a>
                                                </div>
                                                <div class="text">
                                        ...
                                        <div class="item">
                                            <div class="block-34">
                                                <div class="image">
                                                    <a href="#"><img src="<c:url value="/resources/images/menu_2.jpg"/>" alt="Image placeholder"></a>
                                                </div>
                                                <div class="text">
                                        ...
                                        <div class="item">
                                            <div class="block-34">
                                                <div class="image">
                                                    <a href="#"><img src="<c:url value="/resources/images/menu_3.jpg"/>" alt="Image placeholder"></a>
                                                </div>
                                                <div class="text">
                                        ...
                                        <div class="item">
                                            <div class="block-34">
                                                <div class="image">
                                                    <a href="#"><img src="<c:url value="/resources/images/menu_4.jpg"/>" alt="Image placeholder"></a>
                                                </div>
                                                <div class="text">
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-4">
                        ...
                        <div class="block-33">
                            <div class="vcard d-flex mb-3">
                                <div class="image align-self-center"><img src="<c:url value="/resources/images/person_2.jpg"/>" alt="Person here"></div>
                                <div class="name-text align-self-center">
                    ...
                    <div class="col-md-6 col-lg-4">
                        ...
                        <div class="block-33">
                            <div class="vcard d-flex mb-3">
                                <div class="image align-self-center"><img src="<c:url value="/resources/images/person_1.jpg"/>" alt="Person here"></div>
                                <div class="name-text align-self-center">
