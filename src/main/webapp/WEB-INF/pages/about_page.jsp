...
<html>
    ...
    <body>
        ...
        <div class="slider-area">
            <div class="single-slider hero-overly slider-height2 d-flex align-items-center" data-background="<c:url value="/resources/img/hero/aboutpage_hero.jpg"/>" >
                <div class="container">
                    <div class="row ">
                ...
                <div class="row">
                   <div class="col-xl-5 col-lg-6">
                        <div class="customer-img mb-120">
                            <img src="<c:url value="/resources/img/customer/customar1.png"/>" class="customar-img1" alt="">
                            <img src="<c:url value="/resources/img/customer/customar2.png"/>" class="customar-img2" alt="">
                    ...
                    <div class="col-md-12">
                        <div class="gallery-active owl-carousel">
                            <div class="gallery-img">
                                <a href="#"><img src="<c:url value="/resources/img/gallery/gallery1.jpg"/>" alt=""></a>
                            </div>
                            <div class="gallery-img">
                                <a href="#"><img src="<c:url value="/resources/img/gallery/gallery2.jpg"/>" alt=""></a>
                            </div>
                            <div class="gallery-img">
                                <a href="#"><img src="<c:url value="/resources/img/gallery/gallery3.jpg"/>" alt=""></a>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="single-testimonial pt-65">
                                ...
                                <div class="font-back-tittle mb-105">
                                    <div class="archivment-front">
                                        <img src="<c:url value="/resources/img/logo/testimonial.png"/>" alt="">
                                    </div>
