      ...
      <div class="row mb-5">
        ...
        <div class="col-md-6 col-lg-4">
          ...
          <div class="block-21 d-flex mb-4">
            <figure class="mr-3">
                <img src="<c:url value="/resources/images/img_1.jpg"/>" alt="" class="img-fluid">
            </figure>
            <div class="text">
          ...
          <div class="block-21 d-flex mb-4">
            <figure class="mr-3">
                <img src="<c:url value="/resources/images/img_2.jpg"/>" alt="" class="img-fluid">
            </figure>
            <div class="text">
              <h3 class="heading"><a href="#">Our Luxury Hotel &amp; Restaurants</a></h3>
              <div class="meta">
          ...
          <div class="block-21 d-flex mb-4">
            <figure class="mr-3">
                <img src="<c:url value="/resources/images/img_3.jpg"/>" alt="" class="img-fluid">
            </figure>
            <div class="text">
              <h3 class="heading"><a href="#">Our Luxury Hotel &amp; Restaurants</a></h3>
              <div class="meta">
          ...
          <div class="block-23">
            <h3 class="heading-section">Contact Info</h3>
              <ul>
                ...
                <li><a href="#"><span class="icon icon-phone"></span><span class="text">038.331.5959</span></a></li>
                <li><a href="#"><span class="icon icon-envelope"></span><span class="text">khoahoang2408@gmail.com</span></a></li>
