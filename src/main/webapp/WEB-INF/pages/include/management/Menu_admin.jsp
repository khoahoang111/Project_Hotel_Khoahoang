<%-- 
    Document   : Menu_admin
    Created on : Jun 18, 2021, 9:29:35 AM
    Author     : khoa hoang
--%>
                ...
                <div class="top-menu">
                    <ul class="nav navbar-nav pull-right">
                                ...
                                <li>
                                    <ul class="dropdown-menu-list small-slimscroll-style" data-handle-color="#637283">
                                        <li>
                                            <a href="#">
                                                <span class="photo">
                                                    <img src="<c:url value="/resources-management/img/user/user2.jpg"/>" class="img-circle" alt=""> </span>
                                                <span class="subject">
                                        ...
                                        <li>
                                            <a href="#">
                                                <span class="photo">
                                                    <img src="<c:url value="/resources-management/img/user/user3.jpg"/>" class="img-circle" alt=""> </span>
                                                <span class="subject">
                                        ...
                                        <li>
                                            <a href="#">
                                                <span class="photo">
                                                    <img src="<c:url value="/resources-management/img/user/user1.jpg"/>" class="img-circle" alt=""> </span>
                                                <span class="subject">
                                        ...
                                        <li>
                                            <a href="#">
                                                <span class="photo">
                                                    <img src="<c:url value="/resources-management/img/user/user8.jpg"/>" class="img-circle" alt=""> </span>
                                                <span class="subject">
                                        ...
                                        <li>
                                            <a href="#">
                                                <span class="photo">
                                                    <img src="<c:url value="/resources-management/img/user/user5.jpg"/>" class="img-circle" alt=""> </span>
                                                <span class="subject">
                        ...
                        <li class="dropdown dropdown-user">
                            <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                                <img alt="" class="img-circle " src="<c:url value="/resources-management/img/dp.jpg"/>" />
                                        ...
                                        <ul class="docListWindow small-slimscroll-style">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-8 col-sm-8">
                                                        <div class="prog-avatar">
                                                            <img src="<c:url value="/resources-management/img/user/user1.jpg"/>" alt="" width="40" height="40">
                                                        </div>
                                                        <div class="details">
                                                            <div class="title">
                                            ...
                                            <li>
                                                <div class="row">
                                                    <div class="col-md-8 col-sm-8">
                                                        <div class="prog-avatar">
                                                            <img src="<c:url value="/resources-management/img/user/user2.jpg"/>" alt="" width="40" height="40">
                                                        </div>
                                                        <div class="details">
                                                            <div class="title">
                                            ...
                                            <li>
                                                <div class="row">
                                                    <div class="col-md-8 col-sm-8">
                                                        <div class="prog-avatar">
                                                            <img src="<c:url value="/resources-management/img/user/user3.jpg"/>" alt="" width="40" height="40">
                                                        </div>
                                                        <div class="details">
                                                            <div class="title">
                                            ...
                                            <li>
                                                <div class="row">
                                                    <div class="col-md-8 col-sm-8">
                                                        <div class="prog-avatar">
                                                            <img src="<c:url value="/resources-management/img/user/user4.jpg"/>" alt="" width="40" height="40">
                                                        </div>
                                                        <div class="details">
                                                            <div class="title">
                                            ...
                                            <li>
                                                <div class="row">
                                                    <div class="col-md-8 col-sm-8">
                                                        <div class="prog-avatar">
                                                            <img src="<c:url value="/resources-management/img/user/user5.jpg"/>" alt="" width="40" height="40">
                                                        </div>
                                                        <div class="details">
                                                            <div class="title">
                                            ...
                                            <li>
                                                <div class="row">
                                                    <div class="col-md-8 col-sm-8">
                                                        <div class="prog-avatar">
                                                            <img src="<c:url value="/resources-management/img/user/user6.jpg"/>" alt="" width="40" height="40">
                                                        </div>
                                                        <div class="details">
                                                            <div class="title">
                                ...
                                <div class="chat-sidebar-chat-users slimscroll-style" data-rail-color="#ddd" data-wrapper-class="chat-sidebar-list">
                                    ...
                                    <ul class="media-list list-items">
                                        ...
                                        <li class="media">
                                            ...
                                            </div> <img class="media-object" src="<c:url value="/resources-management/img/user/user1.jpg"/>" width="35" height="35" alt="...">
                                            <i class="busy dot"></i>
                                            <div class="media-body">
                                        ...
                                        <li class="media"><img class="media-object" src="<c:url value="/resources-management/img/user/user5.jpg"/>" width="35" height="35" alt="...">
                                            <i class="away dot"></i>
                                            <div class="media-body">
                                        ...
                                        <li class="media">
                                            ...
                                            </div> <img class="media-object" src="<c:url value="/resources-management/img/user/user4.jpg"/>" width="35" height="35" alt="...">
                                            <i class="online dot"></i>
                                            <div class="media-body">
                                        ...
                                        <li class="media"><img class="media-object" src="<c:url value="/resources-management/img/user/user2.jpg"/>" width="35" height="35" alt="...">
                                            <i class="busy dot"></i>
                                            <div class="media-body">
                                        ...
                                        <li class="media"><img class="media-object" src="<c:url value="/resources-management/img/user/user7.jpg"/>" width="35" height="35" alt="...">
                                            <i class="online dot"></i>
                                            <div class="media-body">
                                    ...
                                    <ul class="media-list list-items">
                                        <li class="media">
                                            ...
                                            </div> <img class="media-object" src="<c:url value="/resources-management/img/user/user6.jpg"/>" width="35" height="35" alt="...">
                                        ...
                                        <li class="media"><img class="media-object" src="<c:url value="/resources-management/img/user/user8.jpg"/>" width="35" height="35" alt="...">
                                            <i class="offline dot"></i>
                                            <div class="media-body">
                                        ...
                                        <li class="media">
                                            ...
                                            </div> <img class="media-object" src="<c:url value="/resources-management/img/user/user9.jpg"/>" width="35" height="35" alt="...">
                                            <i class="offline dot"></i>
                                            <div class="media-body">
                                        ...
                                        <li class="media"><img class="media-object" src="<c:url value="/resources-management/img/user/user10.jpg"/>" width="35" height="35" alt="...">
                                            <i class="offline dot"></i>
                                            <div class="media-body">
                            ...
                            <div class="chat-sidebar-item">
                                <div class="chat-sidebar-chat-user">
                                    ...
                                    <div class="chat-sidebar-chat-user-messages">
                                        <div class="post out">
                                            <img class="avatar" alt="" src="<c:url value="/resources-management/img/dp.jpg"/>" />
                                            <div class="message">
                                        ...
                                        <div class="post in">
                                            <img class="avatar" alt="" src="<c:url value="/resources-management/img/user/user5.jpg"/>" />
                                            <div class="message">
